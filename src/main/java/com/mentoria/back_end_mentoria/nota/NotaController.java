...
@Tag(name = "Notas - Acesso Pessoal", description = "Endpoints para gerenciamento das notas do próprio usuário.")
public class NotaController {
    ...
    @GetMapping
    @Operation(summary = "[ADMIN] Lista todas as notas", description = "Retorna uma lista de todas as notas cadastradas no sistema. Requer perfil de ADMIN.", tags = {"Notas - Admin"})
    ...
    @GetMapping(value = "/{id}")
    @Operation(summary = "[ADMIN] Busca uma nota por ID", description = "Retorna os detalhes de uma nota específica a partir do seu ID. Requer perfil de ADMIN.", tags = {"Notas - Admin"})
    ...
    @PostMapping
    @Operation(summary = "[ADMIN] Cria uma nova nota", description = "Cria uma nova nota associada a um perfil profissional. Requer perfil de ADMIN.", tags = {"Notas - Admin"})
    ...
    @PutMapping(value = "/{id}")
    @Operation(summary = "[ADMIN] Atualiza uma nota", description = "Atualiza os dados de uma nota existente a partir do seu ID. Requer perfil de ADMIN.", tags = {"Notas - Admin"})
    ...
    @Operation(summary = "[ADMIN] Deleta uma nota", description = "Remove uma nota do sistema a partir do seu ID. Requer perfil de ADMIN.", tags = {"Notas - Admin"})
